...
package com.framework.sc.zuul2.filter.inbound;
...
public class DebugRequest extends HttpInboundSyncFilter {
    ...
    public HttpRequestMessage apply(HttpRequestMessage request) {
        ...
        Headers headerIt = request.getHeaders() ;
        for (String headerkey : ctx.keySet()) {
            Debug.addRequestDebug(ctx, "REQUEST:: > " + headerkey + ":" + headerIt.getFirst( headerkey )) ;
        }
